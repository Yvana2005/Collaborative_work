...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    name = models.CharField(_("Name"), max_length=200, default="null")
    lastname = models.CharField(max_length=200, default="null")
    birth = models.DateTimeField(default=datetime.now, blank=True, null=True)
    number = models.CharField(max_length=200, default="null")
    adresse = models.CharField(max_length=200, default="null")
    poste = models.CharField(max_length=200, default="null")
